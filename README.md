...
-   **[ Deep Scientific Analysis (Log)](docs/examples/demo_scientific_analysis.txt)**: A raw black-box trace of FailSafe analyzing a complex biomedical claim, showcasing the "Logician," "Skeptic," and "Researcher" agents in debate.
-   **[ Visual Fact-Check Report (General)](docs/examples/demo_visual_report_1.html)**: A comprehensive HTML report generated by the system.
-   **[ Visual Fact-Check Report (Complex)](docs/examples/demo_visual_report_2.html)**: Another example of the system's verifiable output capabilities.
